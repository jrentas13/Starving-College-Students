...
const currentUser = JSON.parse(localStorage.getItem("scsCurrentUser"));
    ...
    <div id="nav2">
        <form action="search.html" class="searchbar">
            ...
            <button id="search-button" type="submit">
                <img src="images/Pan_Search_Icon.PNG" alt="recipes icon">
            </button>
        </form>
        ...
        <div id="AccountArea">
            ${
                currentUser
                    ? `
                    <a href="profile.html"><button id="SignUpButton" type="button">Account</button></a>
                    <button id="LogInButton" type="button" onclick="localStorage.removeItem('scsCurrentUser'); window.location.href='index.html';">Log Out</button>
                    `
                    : `
                    <a href="signup.html"><button id="SignUpButton" type="button">Sign Up</button></a>
                    <a href="login.html"><button id="LogInButton" type="button">Log In</button></a>
                    `
            }
        </div>
    </div>
